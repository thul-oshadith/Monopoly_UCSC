...
void init_Board(GameState *game) {
    ...
    game->board[1].data.property.isCommercial = 1;
    ...
    game->board[6].data.property.isCoastal = 1;
    ...
    game->board[8].data.property.isCoastal = 1;
    ...
    game->board[9].data.property.isCoastal = 1;
    game->board[9].data.property.isCommercial = 1;
    ...
    game->board[13].data.property.isCommercial = 1;
    ...
    game->board[16].data.property.isCoastal = 1;
    game->board[16].data.property.isCommercial = 1;
    ...
    game->board[18].data.property.isCommercial = 1;
    ...
    game->board[21].data.property.isCommercial = 1;
    ...
    game->board[23].data.property.isCommercial = 1;
    ...
    game->board[26].data.property.isCoastal = 1;
    game->board[26].data.property.isSouthernCoastal = 1;
    game->board[26].data.property.isCommercial = 1;
    ...
    game->board[27].data.property.isCoastal = 1;
    game->board[27].data.property.isSouthernCoastal = 1;
    game->board[27].data.property.isCommercial = 1;
    ...
    game->board[29].data.property.isCoastal = 1;
    game->board[29].data.property.isSouthernCoastal = 1;
    game->board[29].data.property.isCommercial = 1;
    ...
    game->board[31].data.property.isCommercial = 1;
    ...
    game->board[32].data.property.isCommercial = 1;
    ...
    game->board[34].data.property.isCoastal = 1;
    game->board[34].data.property.isCommercial = 1;
    ...
    game->board[37].data.property.isCommercial = 1;
    ...
    game->board[39].data.property.isCoastal = 1;
    game->board[39].data.property.isCommercial = 1;
